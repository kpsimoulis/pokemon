...
public class PokemonControllerTest {
    ...
    @Test
    public void causeDamage() throws Exception {
        int damagePoint1 = pokemon1.getDamagePoints();
        pokemonController.causeDamage(10);
        assertEquals(damagePoint1+10, pokemon1.getDamagePoints());
