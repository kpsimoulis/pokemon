...
public class GameControllerIT {
    ...
    private Ability ability = new Ability("Rain Splash", "damage", "put 20 damage points on opponent", "opponent-active");
    ...
    public void setUp() throws Exception {
        ...
        gameControllerTest = new GameController(view);

        gameControllerTest.setEnergyAdded(energyAdded);
        gameControllerTest.setFirstTurn(firstTurn);
        view.setVisible(false);

//        player1Controller.getPlayer().getDeck().populateDeck("res/deck/deck1.txt");
//        player1Controller.buildViewController();
//        player1Controller.initiateGame();
//
//        player2Controller.getPlayer().getDeck().populateDeck("res/deck/deck1.txt");
...
//        player2Controller.initiateGame();
    ...
    public void displayChoiceDialog() throws Exception {
        ...
        gameControllerTest.getAIController().getPlayer().getDeck().populateDeck("res/deck/deck1.txt");
        gameControllerTest.getHumanController().getPlayer().getDeck().populateDeck("res/deck/deck1.txt");
